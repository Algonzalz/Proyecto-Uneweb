<%-- 
    Document   : agregar
    Created on : 10/07/2018, 02:11:28 PM
    Author     : USER
--%>
...
<html>
    ...
    <body>
       ...
       MENU DE NAVEGACIÓN PRINCIPAL
        ...
        <!--  
=====================================================
A PARTIR DE ESTE MOMENTO VIENE EL CODIGO DE AGREGAR
        1.-FORMULARIO DE DATOS QUE TOMO.
=====================================================
        -->

        <%  HttpSession sesion = request.getSession();     // MANEJANDO LAS SESIONES DE USUARIO*
            UsuarioDTO us = (UsuarioDTO) sesion.getAttribute("usuario");
            if (us != null)
            {
        %> 
        <form action="AgregarServlet"  method="get"  name="formulario" class="form-register"  >
            <h1 align="center" class="fomr-titulo">PACIENTE IMC</h1>

            <div class="contenedor-inputs">ID:
                <input type="text" id="txtid" name="txtid"   placeholder="Id"  class="input-100" required maxlength="8"/>


                NOMBRE:
                <input type="text" id="txtnombre" name="txtnombre"  placeholder="Nombre" class="input-100" required pattern="[a-zA-Z]+" title=" NO SE PERMITEN NÚMEROS O CARACTERES ESPECIALES" maxlength="14" />


                APELLIDO:
                <input type="text" id="txtapellido" name="txtapellido"  placeholder="Apellido" class="input-100" required pattern="[a-zA-Z]+" title=" NO SE PERMITEN NÚMEROS O CARACTERES ESPECIALES" maxlength="14" />
                ...
                <div class="contenedor-btn">
                    <input type="submit" value="Agregar" id="Agregar" name="Agregar" class="btn-agregar" />
                    <a href="menu.jsp" ><input type="button" value="Regresar" class="btn-regresar"/></a>
                </div>
            </div>
        </form>
        <!--===================================================================
        CÓDIGO JAVASCRIPT EMBEBIDO PARA VALIDAR LOS INPUTS DE AGREGAR.JSP
        =====================================================================-->
        <script>
            (function () {
